...
pub mod nylon_plugin {
    ...
    impl<'a> HeaderKeyValue<'a> {
        ...
        pub fn key(&self) -> &'a str {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(HeaderKeyValue::VT_KEY, None)
                    .unwrap()
            }
        }
        #[inline]
        pub fn value(&self) -> &'a str {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(HeaderKeyValue::VT_VALUE, None)
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> HeaderKeyValueBuilder<'a, 'b, A> {
        ...
        pub fn add_key(&mut self, key: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(HeaderKeyValue::VT_KEY, key);
        }
        #[inline]
        pub fn add_value(&mut self, value: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(HeaderKeyValue::VT_VALUE, value);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> HeaderKeyValueBuilder<'a, 'b, A> {
